...
import { createHooks } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1 } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/h3@1.13.0/node_modules/h3/dist/index.mjs';
import { CapoPlugin, getActiveHead } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/unhead@1.11.15/node_modules/unhead/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://D:/Code/Nuxt/v4/LearnNuxt/nuxt-boilerplate/node_modules/.pnpm/vue@3.5.13_typescript@5.7.3/node_modules/vue/server-renderer/index.mjs';
...
function Ls() {
  return di || (di = 1, function(i, o2) {
    (function(a2, u) {
      ...
      n(Mi, "isDictionary");
      function ue(e, t2) {
        if (e !== undefined && !Mi(e)) throw new TypeError(`${t2} is not an object.`);
      }
      ...
      const mn = class mn {
        ...
        cancel(t2 = undefined) {
          return Ee(this) ? this._ownerReadableStream === undefined ? b(jt("cancel")) : Wr(this, t2) : b($t("cancel"));
        }
        read() {
          if (!Ee(this)) return b($t("read"));
          if (this._ownerReadableStream === undefined) return b(jt("read from"));
          let t2, r;
          const s2 = E((c, d2) => {
            t2 = c, r = d2;
          });
      ...
      function aa(e, t2, r) {
        ...
        }, "startAlgorithm"), t2.pull !== undefined ? c = n(() => t2.pull(s2), "pullAlgorithm") : c = n(() => T(undefined), "pullAlgorithm"), t2.cancel !== undefined ? d2 = n((R) => t2.cancel(R), "cancelAlgorithm") : d2 = n(() => T(undefined), "cancelAlgorithm");
      ...
      function la(e, t2) {
        ...
        return { mode: r === undefined ? undefined : ua(r, `${t2} has member 'mode' that`) };
      }
      ...
      const Sn = class Sn {
        ...
        cancel(t2 = undefined) {
          return Fe(this) ? this._ownerReadableStream === undefined ? b(jt("cancel")) : Wr(this, t2) : b(Qt("cancel"));
        }
        read(t2, r = {}) {
      ...
      function Gt(e, t2) {
        ...
        return { highWaterMark: r === undefined ? undefined : Ir(r), size: s2 === undefined ? undefined : ha(s2, `${t2} has member 'size' that`) };
      }
      ...
      function pa(e, t2) {
        ...
        return { abort: r === undefined ? undefined : ba(r, e, `${t2} has member 'abort' that`), close: s2 === undefined ? undefined : ma(s2, e, `${t2} has member 'close' that`), start: f2 === undefined ? undefined : ya(f2, e, `${t2} has member 'start' that`), write: d2 === undefined ? undefined : ga(d2, e, `${t2} has member 'write' that`), type: c };
      }
      ...
      const wn = class wn {
        constructor(t2 = {}, r = {}) {
          t2 === undefined ? t2 = null : Jn(t2, "First parameter");
      ...
      function Xr(e, t2) {
        ...
        const s2 = e._writer;
        s2 !== undefined && zo(s2, t2), !Aa(e) && r._started && en(e);
      }
      ...
      const Rn = class Rn {
        ...
        get desiredSize() {
          ...
          if (this._ownerWritableStream === undefined) throw Rt("desiredSize");
          return za(this);
        }
        get ready() {
        ...
        abort(t2 = undefined) {
          return je(this) ? this._ownerWritableStream === undefined ? b(Rt("abort")) : Wa(this, t2) : b(Le("abort"));
        }
        close() {
          if (!je(this)) return b(Le("close"));
          const t2 = this._ownerWritableStream;
          return t2 === undefined ? b(Rt("close")) : he(t2) ? b(new TypeError("Cannot close an already-closing stream")) : Oo(this);
        }
        releaseLock() {
        ...
        write(t2 = undefined) {
          return je(this) ? this._ownerWritableStream === undefined ? b(Rt("write to")) : Fo(this, t2) : b(Le("write"));
        }
      };
      ...
      function qa(e) {
        ...
        return he(t2) || r === "closed" ? T(undefined) : r === "errored" ? b(t2._storedError) : Oo(e);
      }
      ...
      function Io(e) {
        ...
        zo(e, r), Oa(e, r), t2._writer = undefined, e._ownerWritableStream = undefined;
      }
      ...
      function Lo(e, t2, r, s2, f2, c, d2, m) {
        t2._controlledWritableStream = e, e._writableStreamController = t2, t2._queue = undefined, t2._queueTotalSize = undefined, Be(t2), t2._abortReason = undefined, t2._abortController = wa(), t2._started = false, t2._strategySizeAlgorithm = m, t2._strategyHWM = d2, t2._writeAlgorithm = s2, t2._closeAlgorithm = f2, t2._abortAlgorithm = c;
        const R = nn(t2);
        tn(e, R);
        const y = r(), C = T(y);
      ...
      function Ia(e, t2, r, s2) {
        ...
        }, "startAlgorithm"), t2.write !== undefined ? d2 = n((y) => t2.write(y, f2), "writeAlgorithm") : d2 = n(() => T(undefined), "writeAlgorithm"), t2.close !== undefined ? m = n(() => t2.close(), "closeAlgorithm") : m = n(() => T(undefined), "closeAlgorithm"), t2.abort !== undefined ? R = n((y) => t2.abort(y), "abortAlgorithm") : R = n(() => T(undefined), "abortAlgorithm"), Lo(e, f2, c, d2, m, R, r, s2);
      }
      ...
      function Ho(e, t2, r, s2, f2, c) {
        ...
        e._disturbed = true;
        let R = false, y = T(undefined);
        return E((C, P) => {
          let B;
          if (c !== undefined) {
            if (B = n(() => {
              const S = c.reason !== undefined ? c.reason : new Ga("Aborted", "AbortError"), v = [];
              s2 || v.push(() => t2._state === "writable" ? Zt(t2, S) : T(undefined)), f2 || v.push(() => e._state === "readable" ? ie(e, S) : T(undefined)), N(() => Promise.all(v.map((k) => k())), true, S);
          ...
          function nt() {
            return R ? T(true) : q(m._readyPromise, () => E((S, v) => {
              mt(d2, { _chunkSteps: (k) => {
                y = q(Fo(m, k), undefined, u), S(false);
      ...
      function Ka(e, t2, r, s2) {
        ...
        let c, d2, m;
        t2.start !== undefined ? c = n(() => t2.start(f2), "startAlgorithm") : c = n(() => {
        }, "startAlgorithm"), t2.pull !== undefined ? d2 = n(() => t2.pull(f2), "pullAlgorithm") : d2 = n(() => T(undefined), "pullAlgorithm"), t2.cancel !== undefined ? m = n((R) => t2.cancel(R), "cancelAlgorithm") : m = n(() => T(undefined), "cancelAlgorithm"), Qo(e, f2, c, d2, m, r, s2);
      }
      ...
      function Xa(e, t2) {
        ...
        function ae() {
          return s2 ? (f2 = true, T(undefined)) : (s2 = true, mt(r, { _chunkSteps: (N) => {
            ...
            s2 = false, c || $e(y._readableStreamController), d2 || $e(C._readableStreamController), (!c || !d2) && P(undefined);
          }, _errorSteps: () => {
            s2 = false;
          } }), T(undefined));
        }
      ...
      function es(e) {
        ...
        function ae(S) {
          I(S._closedPromise, (v) => (S !== t2 || (K(y._readableStreamController, v), K(C._readableStreamController, v), (!c || !d2) && P(undefined)), null));
        }
        ...
        function nt() {
          Fe(t2) && (_e(t2), t2 = Qe(e), ae(t2)), mt(t2, { _chunkSteps: (v) => {
            ...
            r = false, c || gt(y._readableStreamController), d2 || gt(C._readableStreamController), y._readableStreamController._pendingPullIntos.length > 0 && Ht(y._readableStreamController, 0), C._readableStreamController._pendingPullIntos.length > 0 && Ht(C._readableStreamController, 0), (!c || !d2) && P(undefined);
          }, _errorSteps: () => {
            r = false;
          } });
        }
        ...
        function Oe(S, v) {
          ...
          Eo(t2, S, 1, { _chunkSteps: (it) => {
            ...
            at || gt(k._readableStreamController), fr || gt(Y._readableStreamController), it !== undefined && (at || Vt(k._readableStreamController, it), !fr && Y._readableStreamController._pendingPullIntos.length > 0 && Ht(Y._readableStreamController, 0)), (!at || !fr) && P(undefined);
          }, _errorSteps: () => {
            r = false;
          } });
        }
      ...
      function ns(e) {
        ...
        function c(d2) {
          ...
          if (R === undefined) return T(undefined);
          let y;
          try {
            y = z(R, m, [d2]);
          } catch (P) {
      ...
      const Pn = class Pn {
        ...
        getReader(t2 = undefined) {
          ...
          return la(t2, "First parameter").mode === undefined ? Qe(this) : Co(this);
        }
        pipeThrough(t2, r = {}) {
      ...
      function hs(e, t2) {
        ...
        return { cancel: r === undefined ? undefined : ys(r, e, `${t2} has member 'cancel' that`), flush: s2 === undefined ? undefined : ps(s2, e, `${t2} has member 'flush' that`), readableType: f2, start: c === undefined ? undefined : bs(c, e, `${t2} has member 'start' that`), transform: d2 === undefined ? undefined : ms(d2, e, `${t2} has member 'transform' that`), writableType: m };
      }
      ...
      const An = class An {
        constructor(t2 = {}, r = {}, s2 = {}) {
          ...
          gs(this, B, y, C, m, R), Ss(this, d2), d2.start !== undefined ? P(d2.start(this._transformStreamController)) : P(undefined);
        }
        get readable() {
      ...
      function Ss(e, t2) {
        ...
        }, "transformAlgorithm"), t2.flush !== undefined ? f2 = n(() => t2.flush(r), "flushAlgorithm") : f2 = n(() => T(undefined), "flushAlgorithm"), t2.cancel !== undefined ? c = n((d2) => t2.cancel(d2), "cancelAlgorithm") : c = n(() => T(undefined), "cancelAlgorithm"), _s(e, r, s2, f2, c);
      }
...
var { toStringTag: Et, iterator: xs, hasInstance: Ns } = Symbol, bi = Math.random, Hs = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), mi = n((i, o2, a2) => (i += "", /^(Blob|File)$/.test(o2 && o2[Et]) ? [(a2 = a2 !== undefined ? a2 + "" : o2[Et] == "File" ? o2.name : "blob", i), o2.name !== a2 || o2[Et] == "blob" ? new On([o2], a2, o2) : o2] : [i, o2 + ""]), "f"), zn = n((i, o2) => (o2 ? i : i.replace(/\r?\n|\r/g, `\r
...
const Fn = n((i, o2) => {
  ...
  constructor(o2) {
    ...
    return a2 = a2.length > 0 ? a2.map(([u, l2]) => (gr(u), jn(u, String(l2)), [String(u).toLowerCase(), String(l2)])) : undefined, super(a2), new Proxy(this, { get(u, l2, p) {
      switch (l2) {
        case "append":
        case "set":
...
const o = !!((_b = (_a = globalThis.process) == null ? undefined : _a.env) == null ? undefined : _b.FORCE_NODE_FETCH);
function l() {
...
function createFetchError(ctx) {
  ...
  const method = ((_c = ctx.request) == null ? undefined : _c.method) || ((_d = ctx.options) == null ? undefined : _d.method) || "GET";
...
function resolveFetchOptions(request, input, defaults, Headers2) {
  const headers = mergeHeaders(
    ...
    defaults == null ? undefined : defaults.headers,
    Headers2
  );
  let query;
  if ((defaults == null ? undefined : defaults.query) || (defaults == null ? undefined : defaults.params) || (input == null ? undefined : input.params) || (input == null ? undefined : input.query)) {
    query = {
      ...defaults == null ? undefined : defaults.params,
      ...defaults == null ? undefined : defaults.query,
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  async function executePlugin(plugin) {
    var _a3;
    const unresolvedPluginsForThisPlugin = ((_a3 = plugin.dependsOn) == null ? undefined : _a3.filter((name) => plugins2.some((p) => p._name === name) && !resolvedPlugins.includes(name))) ?? [];
  ...
  for (const plugin of plugins2) {
    if (((_a2 = nuxtApp.ssrContext) == null ? undefined : _a2.islandContext) && ((_b2 = plugin.env) == null ? undefined : _b2.islands) === false) {
      continue;
    }
    registerPluginHooks(nuxtApp, plugin);
  }
  for (const plugin of plugins2) {
    if (((_c = nuxtApp.ssrContext) == null ? undefined : _c.islandContext) && ((_d = plugin.env) == null ? undefined : _d.islands) === false) {
      continue;
    }
...
const unhead_R1H2AoIVhh = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_e5aCfrkqyp = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
    ...
    const router = {
      ...
      back: () => (undefined).history.go(-1),
      go: (delta) => (undefined).history.go(delta),
      forward: () => (undefined).history.go(1),
      // Guards
    ...
    nuxtApp.vueApp.component("RouterLink", defineComponent({
      ...
      setup: (props, { slots }) => {
        ...
        return () => {
          ...
          return props.custom ? (_a2 = slots.default) == null ? undefined : _a2.call(slots, { href: props.to, navigate, route: route2 }) : h("a", { href: props.to, onClick: (e) => {
            e.preventDefault();
            return navigate();
          } }, slots);
        };
...
const revive_payload_server_geDFbsLNtC = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_R1H2AoIVhh,
  router_e5aCfrkqyp,
  revive_payload_server_geDFbsLNtC,
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.1_@parcel+watcher@2.5.0_@types+node@22.10.5_db0@0.2.1_eslint@9.17.0_jiti@2.4.2__ior_my4n7tshn5zo5x33p7lngbvpya/node_modules/nuxt/dist/app/components/welcome.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : undefined;
};
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e2e9cb54"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-B6dLDaPP.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-q5n3uxoo.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.1_@parcel+watcher@2.5.0_@types+node@22.10.5_db0@0.2.1_eslint@9.17.0_jiti@2.4.2__ior_my4n7tshn5zo5x33p7lngbvpya/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.1_@parcel+watcher@2.5.0_@types+node@22.10.5_db0@0.2.1_eslint@9.17.0_jiti@2.4.2__ior_my4n7tshn5zo5x33p7lngbvpya/node_modules/nuxt/dist/app/components/nuxt-root.vue");
